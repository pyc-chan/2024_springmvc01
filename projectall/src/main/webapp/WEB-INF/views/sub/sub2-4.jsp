...
<body>
						...
						<div class="categories">
						    <ul>
						        <li>
						            ...
						            <span class="category">벚나무</span>
						        </li>
						        <li>
						            <figure class="category_icon">
						                <img src="resources/images/garosu_category_icon02.png" alt="은행나무">
						            </figure>
						            <span class="category">은행나무</span>
						        </li>
						        <li>
						            <figure class="category_icon">
						                <img src="resources/images/garosu_category_icon03.png" alt="단풍나무">
						            </figure>
						            <span class="category">단풍나무</span>
						        </li>
						        <li>
						            <figure class="category_icon">
						                <img src="resources/images/garosu_category_icon04.png" alt="자작나무">
						            </figure>
						            <span class="category">자작나무</span>
						        </li>
						        <li>
						            <figure class="category_icon">
						                <img src="resources/images/garosu_category_icon05.png" alt="메타세콰이어">
						            </figure>
						            <span class="category">메타세콰이어</span>
						        </li>
						    </ul>
						</div>
	...
	<script>
		...
		var imageSrc = 'resources/images/map_grosu_icon1.png', // 마커이미지의 주소입니다    
