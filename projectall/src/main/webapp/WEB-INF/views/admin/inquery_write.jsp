...
<body>
	<div class="container">
		...
		<div class="popuplayer">
			<p class="write_title">고객의 소리 게시판 글쓰기</p>
			...
			<form method="post" encType="multipart/form-data">
				<table class="popuptable">
					<tr>
						<td>제목</td>
						<td>
				            <input type="text" name="i_tle" class="in_title" placeholder="제목을 입력해주세요." required>
						</td>
					</tr>
					<tr>
						<td>내용</td>
						<td>
							<textarea id="content" name="i_con" rows="20"></textarea>
						</td>
					</tr>
					<!-- 여기가 첨부파일 입니다. -->
					<tr>
				...
				<div class="btns">
					...
					<button onclick="inquery_write_ok(this.form)">저장</button>
					<button onclick="inquery_list()">목록</button>
				</div>
			</form>
		</div>
	</div>
