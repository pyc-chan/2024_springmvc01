...
<head>
    ...
    <link rel="stylesheet" href="resources/css/my_info_delete.css" />
            ...
            <div id="sub_container">
                <ul class="contents_box">
                    <li class="textcenter">
                        ...
                        <p class="subheading_title_my">회원정보 삭제</p>
                        ...
                        <div id="suc_container">
							...
							<div id="success">
								...
								<p id="username">회원 탈퇴가 완료되었습니다.</p> 
							<div id="infobox">
								<p>그동안 GreenSpotFinder을 찾아주셔서 감사합니다.</p>
							</div>
							<div id="twobtn">
