...
public class ReviewController {
	...
	public ModelAndView getReviewDetail(CommentVO cvo, String cPage) {
		...
		LoginVO lvo = loginService.getDetail(rvo.getU_idx());
		List<CommentVO> clist = commentService.getCommentList(cvo, paging.getOffset(), perPage);
	...
	public ModelAndView getReviewDelete(HttpServletRequest request, String rev_idx) {
		ModelAndView mv = new ModelAndView("redirect:/review/list");
		ReviewVO rvo = reviewService.getReviewDetail(rev_idx);
		reviewFileService.reviewFileDelete(request, rvo);
