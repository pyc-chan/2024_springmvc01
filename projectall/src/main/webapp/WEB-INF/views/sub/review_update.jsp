	                        ...
	                        <div class="content_box">
				                <ul>
				                    <li class="row">
				                        ...
				                        <div class="input">
				                        	<input type="text" name="rev_tle" class="in_title" value="${rvo.rev_tle}" placeholder="제목을 입력해주세요." required>
				                        </div>
				                    </li>
				                    <li class="top">
				                        <div class="label">내용</div>
				                        <div class="input">
				                        	<textarea id="content" name="rev_con" rows="20" placeholder="내용을 입력해주세요.">
				                        		${gvo.rev_con}
				                        	</textarea>
				                        </div>
				                    </li>
				                    <li class="row">
				                        ...
				                        <div class="input">
											<c:choose>
												...
												<c:otherwise>
													<div class="filebox">
													    <input class="upload-name" value="${rvo.rev_filename}" placeholder="파일찾기를 클릭해서 첨부파일을 등록해주세요.">
													    <label for="file">파일찾기</label> 
													    <input type="file" id="file" name="file_name">
													</div>
											
						                            <div class="file_lst">
						                                <label><span>다운로드 : </span> <a href="">${rvo.rev_filename}</a></label>
						                            </div>
												</c:otherwise>
											</c:choose>
