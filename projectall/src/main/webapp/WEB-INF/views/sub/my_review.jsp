...
<head>
    ...
    <link rel="stylesheet" href="resources/css/my_review.css" />
            ...
            <div id="sub_container">
                <ul class="contents_box">
                    <li class="textcenter">
                        ...
                        <p class="subheading_title_my">내가 쓴 리뷰</p>
                        ...
                        <!-- photo list 영역 start -->
		                <ul class="photo_list_review">
		                
		                	<c:forEach var="k" items="${list}">
		                    <li>
		                        <div class="photo_list_img box">
		                            <img src="resources/images/${k.rev_filename }" alt="rewiew_1." class="content">
		                        </div>
		                        <div class="contents">
		                            <p class="place_name">${k.rev_tle}</p>
