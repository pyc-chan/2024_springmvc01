        ...
        <main>
             <div id="sub_container">
                <ul class="contents_box">
                    <li class="textleft">
                        <h2 class="great_title">1대1 문의</h2>
		                    	...
		                    	<c:choose>
		                    		...
		                    		<c:otherwise>
		                    			<c:forEach var="k" items="${list}" varStatus="c">
		                    				 <li onclick="move_notice_detail(${k.q_idx}, ${paging.nowPage})">
					                            <span>${(paging.nowBlock-1)*paging.numPerPage+c}</span>
					                            <p class="title">${k.q_tle}</p>
					                            <em>${k.q_dat}</em>
		                    				 </li>
		                    			</c:forEach>
		                    		</c:otherwise>
